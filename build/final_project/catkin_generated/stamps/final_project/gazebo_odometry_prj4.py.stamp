...
class OdometryNode:
    ...
    def cmd_callback(self, data):
        ...
        delta_x = data.drive.speed * math.cos(self.yaw) * dt * 0.52#0.5
        delta_y = data.drive.speed * math.sin(self.yaw) * dt * 0.52#0.5

        self.current_angular_velocity = data.drive.speed * math.tan(data.drive.steering_angle) / (data.drive.speed / 40 + 1.01) #/ (1 + abs(data.drive.steering_angle)/20)  #1.4 #adjustable
#self.current_angular_velocity = data.drive.speed * math.tan(data.drive.steering_angle) / 1.1 #1.03   #0.325 bigger than 1 , smaller than 1.1
        ...
        self.v = data.drive.speed * 0.52#0.5
