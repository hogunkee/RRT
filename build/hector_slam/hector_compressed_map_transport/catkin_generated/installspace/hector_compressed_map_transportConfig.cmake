...
if("FALSE" STREQUAL "TRUE")
  set(hector_compressed_map_transport_SOURCE_PREFIX /home/gun2/catkin_ws/src/hector_slam/hector_compressed_map_transport)
  set(hector_compressed_map_transport_DEVEL_PREFIX /home/gun2/catkin_ws/devel)
  ...
  set(hector_compressed_map_transport_INSTALL_PREFIX /home/gun2/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'hector_compressed_map_transport' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Johannes Meyer <meyer@fsr.tu-darmstadt.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'hector_compressed_map_transport' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gun2/catkin_ws/install/${idir}'.  Ask the maintainer 'Johannes Meyer <meyer@fsr.tu-darmstadt.de>' to fix it.")
    endif()
