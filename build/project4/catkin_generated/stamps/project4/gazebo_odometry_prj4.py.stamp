...
class OdometryNode:
    ...
    def cmd_callback(self, data):
        ...
        self.current_angular_velocity = data.drive.speed * math.tan(data.drive.steering_angle) / (data.drive.speed / 2 + 1) / (1 + abs(data.drive.steering_angle)/2)  #1.4 #adjustable
