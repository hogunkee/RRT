...
if("TRUE" STREQUAL "TRUE")
  set(hector_nav_msgs_SOURCE_PREFIX /home/gun2/catkin_ws/src/hector_slam/hector_nav_msgs)
  set(hector_nav_msgs_DEVEL_PREFIX /home/gun2/catkin_ws/devel)
  ...
  set(hector_nav_msgs_INSTALL_PREFIX /home/gun2/catkin_ws/install)
...
if(NOT "/home/gun2/catkin_ws/devel/include " STREQUAL " ")
  set(hector_nav_msgs_INCLUDE_DIRS "")
  set(_include_dirs "/home/gun2/catkin_ws/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'hector_nav_msgs' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Johannes Meyer <meyer@fsr.tu-darmstadt.de>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'hector_nav_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/gun2/catkin_ws/src/hector_slam/hector_nav_msgs/${idir}'.  Ask the maintainer 'Johannes Meyer <meyer@fsr.tu-darmstadt.de>' to fix it.")
    endif()
